...
InstructionResult block11(uint8_t* ram, uint8_t opcode) {
    ...
    case 0b11001011: // All prefixed 0xCB opcodes
        instruction_result = prefixCB(ram, *(ram+get_r16(R16PC)+1));
        break;
...
InstructionResult run_instruction(uint8_t* ram) {
    ...
    {
    case 0:
        instruction_result = block00(ram, opcode);
        break;
    case 1:
        instruction_result = block01(ram, opcode);
        break;
    case 2:
        instruction_result = block10(ram, opcode);
        break;
    case 3:
        instruction_result = block11(ram, opcode);
        break;
    }
